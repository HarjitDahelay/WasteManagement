...
<body>
    ...
    <li><a href="viewstatus.jsp" class="current">View Status</a></li>
...
%>
    ...
    String query1="select * from request where flatno = '"+flatno+"'"; 
    Statement st1=co.createStatement();
    ResultSet rs=st1.executeQuery(query1);
      
    %>
    <center>
        <h2><font color="black" size="5"> View Status</font></h2><br/>
